...
/// drag gesture carries a fresh, independent [WidgetData] instance.
class WidgetCatalogItem {
  ...
  /// Factory that produces a new [WidgetData] for each drag.
  final WidgetData Function() payloadFactory;
}
